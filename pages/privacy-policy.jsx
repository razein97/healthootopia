      ...
      <div className="mx-auto my-0 lg:w-full xl:w-[1080px]  2xl:w-[1080px]">
        <div className="privacy-policy grid gap-4 p-6">
          ...
          <p className=" text-justify font-OpenSans text-base font-light md:text-lg">
            Healthootopia (“us”, “we”, or “our”) operates the
            https://healthootopia.com website (hereinafter referred to as the
            “Healthootopia”). <br /> This page informs you of our policies
            regarding the collection, use, and disclosure of personal data when
            you use Healthootopia and the choices you have associated with that
            data. <br />
            We use your data to provide and improve the Service. By using
            Healthootopia, you agree to the collection and use of information in
          ...
          <h3 className="font-PlayfairDisplay text-xl md:text-3xl">
            Types of Data Collected
          </h3>
          <h4 className="font-PlayfairDisplay text-lg md:text-2xl">
            Personal Data
          </h4>
          <p className="text-justify font-OpenSans text-base font-light md:text-lg">
          ...
          <h3 className="font-PlayfairDisplay text-xl md:text-3xl">Comments</h3>
          <p className="text-justify font-OpenSans text-base font-light md:text-lg">
          ...
          <h3 className="font-PlayfairDisplay text-xl md:text-3xl">Media</h3>
          <p className="text-justify font-OpenSans text-base font-light md:text-lg">
          ...
          <h3 className="font-PlayfairDisplay text-xl md:text-3xl">Cookies</h3>
          <p className="text-justify font-OpenSans text-base font-light md:text-lg">
          ...
          <p className="text-justify font-OpenSans text-base font-light md:text-lg">
            ...
            healthootopia.com available to Google Analytics by installing the
          ...
          <p className="text-justify font-OpenSans text-base font-light md:text-lg">
            ...
            likes/shares/recommends and “like/share/recommend” our webpages.
            This widget may collect your IP address, your web browser User
            Agent, store and retrieve cookies on your browser, embed additional
            tracking, and monitor your interaction with the widget, including
            correlating your Facebook account with whatever action you take
            within the widget (such as “liking/sharing/recommending” our
            webpage), if you are logged in to Facebook. For more information
            about how this data may be used, please see Facebook’s data privacy
            policy: https://www.facebook.com/about/privacy/update <br />
            We use a Twitter Tweet widget at our website. As a result, our
            website makes requests to Twitter’s servers for you to be able to
            tweet our webpages using your Twitter account. These requests make
            your IP address visible to Twitter, who may use it in accordance
            with their data privacy policy:
            https://twitter.com/en/privacy#update <br />
            We use a Linkedin Share widget at our website to allow you to share
            our webpages on Linkedin. These requests may track your IP address
            in accordance with their data privacy policy:
            https://www.linkedin.com/legal/privacy-policy <br />
            We use Pinterest Save widget at our website to allow you to pin
            images to Pinterest from our webpages. These requests may track your
            IP address in accordance with their data privacy policy:
            https://policy.pinterest.com/en/privacy-policy <br />
            We use Reddit Badge widget at our website which may log information
            when you interact with the widget. This may include your IP address,
            user-agent string, browser type, operating system, referral URLs,
            device information (e.g., device IDs), pages visited, links clicked,
            user interactions (e.g., voting data), the requested URL and
            hardware settings, in accordance with their privacy policy:
          ...
          <h4 className="font-PlayfairDisplay text-2xl">Legal Requirements</h4>
          <p className="text-justify font-OpenSans text-base font-light md:text-lg">
            Healthootopia may disclose your Personal Data in the good faith
            belief that such action is necessary to:
          </p>
          <ul className="list-disc pl-10">
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the rights or property of Healthootopia
            </li>
            <li>
          ...
          <p className="text-justify font-OpenSans text-base font-light md:text-lg">
            ...
            service. Your information, including Personal Data, may be
            ...
            Data, to India and process it there. <br />
            Your consent to this Privacy Policy followed by your submission of
            such information represents your agreement to that transfer. <br />
            Healthootopia will take all steps reasonably necessary to ensure
          ...
          <p className="text-justify font-OpenSans text-base font-light md:text-lg">
            Healthootopia may contain links to other sites that are not operated
          ...
          <p className="text-justify font-OpenSans text-base font-light md:text-lg">
            Healthootopia does not address anyone under the age of 18
            (“Children”). <br />
